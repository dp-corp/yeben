...
<head>
<meta charset="utf-8">
<title><?php echo $setting['site_name']; ?> - Home</title>
...
.content-outer {
    position: relative;
    z-index: 3; /* Ensure content stays above the dark overlay */
    display: flex;
   ...
   <?php include "header.php"; ?>
            ...
            <div class="content-wrapper">
                ...
                <div class="contact-widget">
                    <div class="icon-box">
                        ...
                        <div class="text">Ethiopia, Addis Ababa <br> Bole.</div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-calling"></span></div>
                        <div class="text"><strong>Phone</strong><a href="tel:+251987654321">+251 987 654 321</a></div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-mail"></span></div>
                        <div class="text"><strong>Email</strong><a href="yeben@gmail.com">yeben@gmail.com</a></div>
                    </div>
                </div>
                <!-- Link Btn -->
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <div class="slide-background" style="background-image: url(assets/images/post/all2.jpg);"></div>
            <div class="content-outer">
                <div class="content-box">
                    <div class="inner text-center">
                        <h1>DON'T BE AFRAID<br>
                            TO START AND<br>
                            TAKE ACTION</h1>
                        <div class="link-box">
        ...
        <!-- Slide Item -->
        <div class="swiper-slide">
            <div class="slide-background" style="background-image: url(assets/images/post/all1.png);"></div>
            <div class="content-outer">
                <div class="content-box">
                    <div class="inner text-center">
                        <h1>Start where you are. <br>
        ...
        <!-- Slide Item -->
        <div class="swiper-slide">
            <div class="slide-background" style="background-image: url(assets/images/post/meeting.jpg);"></div>
            <div class="content-outer">
                <div class="content-box">
                    <div class="inner text-center">
                        <h1>Dream big, <br>
        ...
        <div class="banner-slider-nav style-two w-100">
            <div class="d-flex justify-content-between align-items-center w-100">
                <div class="banner-slider-control banner-slider-button-prev">
                    <span><i class="far fa-angle-left"></i><span class="d-none d-md-inline">Prev</span></span>
                </div>
                <div class="banner-slider-control banner-slider-button-next">
                    <span><span class="d-none d-md-inline">Next</span><i class="far fa-angle-right"></i></span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="about-section" style="background-image: url(assets/images/background/bg-1.jpg);">
        <div class="auto-container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="sec-title">
                        <div class="sub-title">Our Purpose</div>
                        <h2>Who we are</h2>
                        <div class="text">We are a home grown Endowment Fund, established in the memory of Dr. Benyam Asefa, located in Addis Ababa, Ethiopia.</div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1500ms">
                                ...
                                <div class="content">
                                    <span><h4>Offer Mentorship and Networking Opportunities</h4></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1500ms">
                                ...
                                <div class="content">
                                    <span><h4>Recognize innovation and excellence</h4></span>
                        ...
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1700ms">
                                ...
                                <div class="content">
                                    <span><h4>Provide Financial Support</h4></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1900ms">
                                ...
                                <div class="content">
                                    <span><h4>Provide life skills and leadership training</h4></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Facts Section -->
    <section class="facts-section" style="background-image: url(assets/images/background/bg-1.jpg);">
        <div class="auto-container">
            <div class="wrapper-box" style="background-image: url(assets/images/post/all1.png);">
                <div class="shape">
                        ...
                        <div class="column counter-column col-md-6">
                            <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    ...
                                    <div class="text">Total Beneficiaries</div>
                                </div>
                            </div>
                        </div>
                        <!--Column-->
                        ...
                        <div class="column counter-column col-md-6">
                            <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    ...
                                    <div class="text">Beneficiaries / year</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- serivice from here -->
        ...
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h2>Our <font color = #fd7e14>Services</font></h2>
                <!-- <h2>Our Services</h2> -->
            </div>
    ...
    <section class="Whychooseus-section">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h2>Our <font color = #fd7e14>Purpose</font></h2>
            </div>
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 why-choose-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        ...
                        <div class="content">
                            <h4>Provide life skills and leadership training</h4>
                ...
                <div class="col-lg-6 col-md-6 why-choose-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        ...
                        <div class="content">
                            <h4>Recognize innovation and excellence </h4>
                ...
                <div class="col-lg-6 col-md-6 why-choose-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        ...
                        <div class="content">
                            <h4>Offer Mentorship and Networking Opportunities</h4>
    ...
    <section class="work-process-section">
        ...
        <div class="auto-container">
            ...
            <div class="bottom-text">Empowering Innovation with Financial Support, Leadership Training, and Recognition.  <a href="contact.php"> Connect with Us Today!</a></div>
        </div>
    </section>
