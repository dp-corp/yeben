...
<head>
    ...
    <meta name="description" content="We Offer Import & Export assistance foreign businesses in transporting and selling their products in China,
                                India and USA. We connect domestic companies to the international shipping services most suited for their business.">
    <!-- Stylesheets -->
...
<body>
    ...
    <div class="page-wrapper">
            ...
            <div class="wrapper-box">
                <div class="content-wrapper">
                    ...
                    <div class="icon-box">
                        ...
                        <div class="text"><strong>Email</strong><a href="tel:(+61)32456789790">supportyou@Yeben.com</a></div>
                    </div>
                </div> -->
                    <!-- Link Btn -->
                    <div class="link-btn"><a href="#" class="theme-btn btn-style-one style-two"><span><i
                                    class="flaticon-up-arrow"></i>Book Our Class </span></a></div>
                </div>
            </div>
        </section>
        ...
        <!-- Page Title -->
        <section class="page-title" style="background-image: url(assets/images/images/faqq.jpg);">
                            ...
                            <ul class="accordion-box style-two mb-30">
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        ...
                                        What are the usual methods of freight payment in Yeben?
                                    </div>
                                    <div class="acc-content">
                                        <div class="content">
                                            <div class="text">Equal blame belongs to those who fail in their duty
