    ...
    <body>
        ...
        <div class="page-wrapper">
                ...
                <div class="wrapper-box">
                    <div class="content-wrapper">
                        ...
                        <div class="text-widget sidebar-widget">
                            ...
                            <div class="text">service above self</div>
                        </div>
                        <!-- PDF Widget -->
                        ...
                        <div class="contact-widget">
                            <div class="icon-box">
                                ...
                                <div class="text">Ethiopia, Addis Ababa, 4Kilo</div>
                            </div>
                            <div class="icon-box">
            ...
            <section class="faq-section">
                <div class="auto-container">
                    <div class="sec-title text-center"><br><br><br><br>
                        
                        <h2 class="pb-3">Terms & Conditions</h2><br><br>
