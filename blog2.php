...
<div class="page-wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="text-widget sidebar-widget">
                    ...
                    <style>
                        ...
                        /* Optional: You can adjust the size of the container too */
                        .logo {
    ...
    <div id="search-popup" class="search-popup">
        ...
        <div class="popup-inner">
            ...
            <div class="search-form">
                <form method="post" action="http://st.ourhtmldemo.com/new/Yeben2/index.html">
    ...
    <!-- Page Title -->
    <section class="page-title" style="background-image: url(assets/images/newsheadline.jpg);">
                ...
                <aside class="col-lg-3 sidebar">
                    <div class="blog-sidebar">
                        <div class="widget widget_search">
                            ...
                            <form action="http://st.ourhtmldemo.com/new/Yeben2/blog-2.html" method="post" class="search-form">
                                <div class="form-group">
